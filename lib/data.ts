...
export const personalInfo = {
  name:       'L4Code',
  fullName:   'L4Code Developer',
  tagline:    'Building the Future, One Deployment at a Time',
  email:      'contact@L4Code.com',
  location:   'Remote · Indonesia',
  github:     'https://github.com/L4Code',
  linkedin:   'https://linkedin.com/in/L4Code',
  discord:    'L4Code#0000',
  telegram:   'https://t.me/L4Code',
  twitter:    'https://twitter.com/L4Code',
...
export const projects: Project[] = [
  {
    ...
    github:      'https://github.com/L4Code/k8s-monitoring-stack',
    demo:        '#',
  ...
  },
  {
    ...
    github:      'https://github.com/L4Code/devsecops-pipeline',
    demo:        '#',
  ...
  },
  {
    ...
    github:      'https://github.com/L4Code/blockchain-nodes',
    demo:        '#',
  ...
  },
  {
    ...
    github:      'https://github.com/L4Code/ai-infra',
    demo:        '#',
    color:       'from-green-400 to-cyan-500',
    icon:        '🤖',
    featured:    true,
  },
  {
    ...
    github:      'https://github.com/L4Code/cloud-logging',
    demo:        '#',
  ...
  },
  {
    ...
    github:      'https://github.com/L4Code/gitops-platform',
    demo:        '#',
